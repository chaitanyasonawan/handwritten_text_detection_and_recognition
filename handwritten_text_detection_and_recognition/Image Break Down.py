...
parser.add_argument('--data', type=Path, default=Path(r"C:\Users\Yash\Downloads\handwritten_text_detection_and_recognition-master\handwritten_text_detection_and_recognition-master\data\page"))
    ...
    for fn_img in get_img_files(parsed.data):
        ...
        for line_idx, line in enumerate(lines):
            for word_idx, det in enumerate(line):
                ...
                path = r"C:\Users\Yash\Downloads\handwritten_text_detection_and_recognition-master\handwritten_text_detection_and_recognition-master\test_images"
